 ...
 <div class="bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-300">
     <div
         ...
         <h1 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Berita Terbaru</h1>
         <p class="mt-2 text-lg text-white">Informasi terkini dari Dinas Komunikasi dan Informatika Kabupaten.</p>
     </div>
 </div>

...
@section('title', 'Video Kegiatan - Diskominfo Kabupaten Penajam Paser Utara')
    ...
    <section id="berita" class="py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-neutral-700">Video</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-10 flex items-end justify-between">
                <div class="">
                    <h2 class="text-2xl font-semibold tracking-tight sm:text-3xl text-emerald-600">Semua Video</h2>

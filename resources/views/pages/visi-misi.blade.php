...
@section('title', 'Visi dan Misi - Diskominfo Kabupaten Penajam Paser Utara')
    ...
    <section id="berita" class="py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-neutral-700">Visi dan Misi</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-10 flex items-end justify-between">
                <div class="">
                    <h2 class="text-2xl font-semibold tracking-tight sm:text-3xl text-emerald-600">Visi dan Misi</h2>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div class="grid gap-6 col-span-3 lg:col-span-3">
                    ...
                    <div class="grid gap-8  ">
                        ...
                        {{-- VISI --}}
                        <div
                            class="bg-gradient-to-br from-emerald-600 to-emerald-400 p-8 rounded-2xl w-full shadow-lg text-white">
                            <h2 class="text-3xl font-bold mb-4 border-b border-white/30 pb-2">Visi</h2>
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-lg border-1 border-emerald-200">
                            <h2 class="text-3xl font-bold mb-4 text-emerald-600 border-b border-emerald-200 pb-2">Misi</h2>
                            <ol class="list-decimal list-inside space-y-3 text-neutral-700 text-lg">
                                @php
                                    $misi = $profile->misi ?? '';
                                    $misiList = explode(',', $misi);
